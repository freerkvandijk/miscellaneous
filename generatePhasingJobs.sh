...
mkdir -p /groups/umcg-bios/tmp04/projects/phasing/jobs_smallChunks/filter_GQ20/shapeit/chr$i/
...
RESULTSDIR="/groups/umcg-bios/tmp04/projects/phasing/results_GQ20//shapeitSmallChunks/chr$CHR/"
...
if shapeit \\
 -call \\
 --input-gen /groups/umcg-bios/tmp04/projects/phasing/results_GQ20//beagle_vcf_filtered//BIOS_freeze2.chr$CHR.beagle.genotype.probs.DR2_filtered.gg.gen.gz \\
             /groups/umcg-bios/tmp04/projects/phasing/results_GQ20//beagle_vcf_filtered//BIOS_freeze2.chr$CHR.beagle.genotype.probs.DR2_filtered.gg.gen.sample \\
 --input-init /groups/umcg-bios/tmp04/projects/phasing/results_GQ20//beagle_vcf_filtered//BIOS_freeze2.chr$CHR.beagle.genotype.probs.DR2_filtered.gg.hap.gz \\
              /groups/umcg-bios/tmp04/projects/phasing/results_GQ20//beagle_vcf_filtered//BIOS_freeze2.chr$CHR.beagle.genotype.probs.DR2_filtered.gg.hap.sample \\
 --input-map /apps/data/www.shapeit.fr/genetic_map_b37//genetic_map_chr$CHR\_combined_b37.txt \\
 --input-scaffold /groups/umcg-lld/tmp04/projects/genotypingRelease3/selectionLldeep/lldeepPhased_RNA_IDs//chr_$CHR.haps \\
                  /groups/umcg-lld/tmp04/projects/genotypingRelease3/selectionLldeep/lldeepPhased_RNA_IDs//chr_$CHR.sample \\
 --input-thr 1.0 \\
 --thread 4 \\
 --window 0.1 \\
 --states 400 \\
...
">./jobs_smallChunks/filter_GQ20/shapeit/chr$i/ShapeitPhasing.chr$CHR.$START.$END.sh

done</groups/umcg-bios/tmp04/projects/phasing/molgenis-pipelines_smallChunks/compute5/BIOS_phasing/chromosomes/chromosome_chunks_chr$i.csv
